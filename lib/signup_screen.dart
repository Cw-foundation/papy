    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          decoration: const BoxDecoration(color: Color(0xFFD90000)),
          child: Column(
              ...
              const Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 10),
                    Text("Registre-se para usar esta App poderosa", style: TextStyle(color: Colors.white, fontSize: 15)),
                  ],
                ),
              ),
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          decoration: const InputDecoration(
                            labelText: "E-mail",
                            prefixIcon: Icon(Icons.email, color: Color(0xFFD90000)),
                        ...
                        TextFormField(
                          ...
                          decoration: const InputDecoration(
                            labelText: "Senha",
                            prefixIcon: Icon(Icons.lock, color: Color(0xFFD90000)),
                            border: OutlineInputBorder(),
                          ),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                        ...
                        TextFormField(
                          ...
                          decoration: const InputDecoration(
                            ...
                            prefixIcon: Icon(Icons.business, color: Color(0xFFD90000)),
                            border: OutlineInputBorder(),
                          ),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
